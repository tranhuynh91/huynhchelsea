...
<div class="content">
    <!-- BEGIN REGISTER FORM -->
    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'/register_editdvvt/id='. $model->id, 'class'=>'horizontal-form','id'=>'update_register']) !!}
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Tên doanh nghiệp" name="tendn" id="tendn" value="{{$model->tendn}}" autofocus required>
                    </div>
                </div>
            </div>
            <!--/span-->
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-icon">
                        <i class="fa fa-key"></i>
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Mã số thuế" name="masothue" id="masothue" value="{{$model->masothue}}" required>
                    </div>
                </div>
            </div>
            <!--/span-->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="emaildn" id="emaildn" value="{{$model->email}}" required>
                    </div>
                </div>
            </div>
            <!--/span-->
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-icon">
                        <i class="fa fa-check"></i>
                        <input class="form-control required" type="text" placeholder="Nơi đăng ký nộp thuế" name="noidknopthue" id="noidknopthue"  value="{{$model->noidknopthue}}" required>
                    </div>
                </div>
            </div>
            <!--/span-->
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" id="username" value="{{$model->username}}" required>
            </div>
        </div>
        <div class="form-group">
